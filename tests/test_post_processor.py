    ...
    return [
        OuterLoopResults(
            ...
            max_eval=FeatureEvaluationResults(
                test_score=0,
                ranks=FeatureRanks(features=[1, 2, 3, 4], ranks=[2, 1, 3, 4], n_feats=5)
            ),
        ...
        OuterLoopResults(
            ...
            max_eval=FeatureEvaluationResults(
                test_score=0,
                ranks=FeatureRanks(features=[0, 1, 2, 3], ranks=[1, 2, 3, 4], n_feats=5)
            ),
            mid_eval=FeatureEvaluationResults(
                test_score=0,
...
def outer_loop_results2():
    return [
        OuterLoopResults(
            ...
            max_eval=FeatureEvaluationResults(
                test_score=0,
                ranks=FeatureRanks(features=[0, 1, 2, 3], ranks=[3, 1, 2, 4], n_feats=5)
            ),
            mid_eval=FeatureEvaluationResults(
                test_score=0,
                ranks=FeatureRanks(features=[0, 1, 2], ranks=[3, 1, 2], n_feats=5)
        ...
        OuterLoopResults(
            ...
            max_eval=FeatureEvaluationResults(
                test_score=0,
                ranks=FeatureRanks(features=[0, 1, 2, 4], ranks=[4, 3, 1, 2], n_feats=5)
            ),
            mid_eval=FeatureEvaluationResults(
                test_score=0,
